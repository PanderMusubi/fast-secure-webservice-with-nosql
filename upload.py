...
upload(edata1a, host, path, headers, conn)
upload(edata1b, host, path, headers, conn)
upload(edata2a, host, path, headers, conn)
upload(edata2b, host, path, headers, conn)
upload(edata3a, host, path, headers, conn)
upload(edata3b, host, path, headers, conn)
upload(edata4a, host, path, headers, conn)
upload(edata4b, host, path, headers, conn)
upload(edata5a, host, path, headers, conn)
upload(edata5b, host, path, headers, conn)
upload(edata6a, host, path, headers, conn)
upload(edata6b, host, path, headers, conn)
